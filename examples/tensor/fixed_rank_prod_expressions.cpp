...
int main()
{
  ...
  // dynamic_extents with static rank
  {
    ...
    auto A         = fixed_rank_tensor<value_t, 3>(n, value_t(2));
  ...
  // dynamic_extents with static rank
  {
    ...
    q = 1u;
    tensor_t C1 =
      fixed_rank_tensor<value_t, 3>(extents_3_t{m, n[1], n[2]}, value_t(2)) +
  ...
  // dynamic_extents with static rank
  {
    ...
    auto A         = fixed_rank_tensor<value_t, 3>(na, value_t(2));
    auto B         = fixed_rank_tensor<value_t, 4>(nb, value_t(3));
    ...
    // to dynamic tensor
    tensor_t C1 =
      dynamic_tensor<float>(dynamic_extents<>{na[2], na[2]}, value_t(2)) +
      prod(A, A, perm_t{1, 2}) + 5;
    ...
    tensor_t C2 = dynamic_tensor<float>(dynamic_extents<>{na[2], nb[1], nb[3]},
                                        value_t(2)) +
