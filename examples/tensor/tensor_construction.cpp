...
int main()
{
   ...
   * Initial Value: 0
   **/
  auto tensor_dynamic_extents_and_dynamic_rank_0 =
    ub::dynamic_tensor<value_type>{1, 2, 3, 4};
   ...
   * Initial Value: 0
   **/
  auto tensor_dynamic_extents_and_static_rank_1 =
    ub::fixed_rank_tensor<value_type, 4>{ub::dynamic_extents<4>{1, 2, 3, 4}};
   ...
   * Initial Value: 0
   **/
  auto tensor_dynamic_extents_and_dynamic_rank_2 =
    ub::dynamic_tensor<value_type>{ub::dynamic_extents<>{1, 2, 3, 4}};
   ...
   * Initial Value: 0.1f
   **/
  auto tensor_dynamic_extents_and_dynamic_rank_3 =
    ub::dynamic_tensor<value_type>{ub::dynamic_extents<>{1, 2, 3, 4}, 0.1};
   ...
   * Initial Value: 0
   **/
  auto tensor_static_extents_and_static_rank_4 =
    ub::static_tensor<value_type, ub::static_extents<1, 2, 3, 4>>();
   ...
   * Initial Value: 0
   **/
  auto tensor_static_extents_and_static_rank_5 =
    ub::static_tensor<value_type,
                      ub::static_extents<1, 2, 3, 4>,
   ...
   * Initial Value: 0
   **/
  auto tensor_dynamic_extents_and_dynamic_rank_6 =
    ub::dynamic_tensor<value_type, ub::layout::first_order>{1, 2, 3, 4};
