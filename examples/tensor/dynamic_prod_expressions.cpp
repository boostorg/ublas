...
int main()
{
  ...
  // Tensor-Matrix-Multiplications - Including Transposition
  {
    ...
    q           = 1u;
    tensor_t C1 = tensor_t(dynamic_extents<>{m, n[1], n[2]}, 2) +
  ...
  // Tensor-Tensor-Multiplications Including Transposition
  {
    ...
    tensor_t C1 = tensor_t(dynamic_extents<>{na[2], na[2]}, 2) +
    ...
    tensor_t C2 = tensor_t(dynamic_extents<>{na[2], nb[1], nb[3]}, 2) +
    ...
    tensor_t C3 = tensor_t(dynamic_extents<>{na[2], nb[1], nb[3]}, 2) +
