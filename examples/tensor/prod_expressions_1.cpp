...
int main()
{
	...
	// dynamic_extents with dynamic rank
	{
		...
		auto A = dynamic_tensor(n,value_t(2));
	...
	// dynamic_extents with dynamic rank
	{
		...
		q = 1u;
		tensor_t C1 = dynamic_tensor( dynamic_extents<>{m,n[1],n[2]},value_t(2) ) + prod(A,matrix_t(m,n[q-1],1),q);
	...
	// dynamic_extents with dynamic rank
	{
		...
		auto A = dynamic_tensor(na,value_t(2));
		auto B = dynamic_tensor(nb,value_t(3));
		using tensor_t = decltype(A);


		// C1(j,l) = T(j,l) + A(i,j,k)*A(i,j,l) + 5;
		tensor_t C1 = dynamic_tensor(dynamic_extents<>{na[2],na[2]},value_t(2)) + prod(A,A,perm_t{1,2}) + 5;
		...
		tensor_t C2 = dynamic_tensor(dynamic_extents<>{na[2],nb[1],nb[3]},value_t(2)) + prod(A,B,perm_t{1,2},perm_t{3,1}) + 5;
		...
		tensor_t C3 = dynamic_tensor(dynamic_extents<>{na[2],nb[1],nb[3]},value_t(2)) + prod(A,trans(B,{2,3,1,4}),perm_t{1,2}) + 5;
