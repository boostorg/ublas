...
template <typename T> struct is_valid : std::integral_constant<bool, false> {
};
...
struct is_valid<basic_static_extents<ExtentsType, E0, E1>> {
  static constexpr bool const value =
    (E0 > ExtentsType(0)) && (E1 > ExtentsType(0));
};
...
template <typename T> struct is_scalar : std::integral_constant<bool, false> {
};
...
struct is_scalar<basic_static_extents<ExtentsType, E0, E1, E...>> {
  static constexpr bool const value =
    is_scalar_v<basic_static_extents<ExtentsType, E0>> &&
    is_scalar_v<basic_static_extents<ExtentsType, E1, E...>>;
};
...
template <typename T> struct is_vector : std::integral_constant<bool, false> {
};
...
template <typename T> struct is_matrix : std::integral_constant<bool, false> {
};
...
template <typename T>
inline static constexpr bool const is_any_greater_than_one_v =
  is_any_greater_than_one<T>::value;

template <typename ExtentsType, ExtentsType... E>
struct is_any_greater_than_one<basic_static_extents<ExtentsType, E...>>
  : std::false_type {
};
...
struct is_any_greater_than_one<basic_static_extents<ExtentsType, E0, E...>> {
  static constexpr bool const value =
    is_any_greater_than_one_v<basic_static_extents<ExtentsType, E0>> ||
    is_any_greater_than_one_v<basic_static_extents<ExtentsType, E...>>;
};

template <typename T> struct is_tensor : std::integral_constant<bool, false> {
};
...
struct is_tensor<basic_static_extents<ExtentsType, E0, E1, E2, E...>> {
  static constexpr bool const value =
    is_any_greater_than_one_v<basic_static_extents<ExtentsType, E2, E...>>;
};
