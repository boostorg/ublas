...
struct basic_slice<T>
{
    ...
    constexpr auto &last() const noexcept { return last_; }
    constexpr auto &step() const noexcept { return step_; }
...
template <ptrdiff_t... Args>
using slice = basic_slice<size_t, Args...>;
