...
namespace boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        public:
            ...
            typename self_type::
#endif
            reverse_iterator2 crbegin () const {
                return rbegin ();
            }
            BOOST_UBLAS_INLINE
#ifdef BOOST_UBLAS_MSVC_NESTED_CLASS_RELATION
        ...
        public:
            ...
            typename self_type::
#endif
            reverse_iterator1 crbegin () const {
                return rbegin ();
            }
            BOOST_UBLAS_INLINE
#ifdef BOOST_UBLAS_MSVC_NESTED_CLASS_RELATION
