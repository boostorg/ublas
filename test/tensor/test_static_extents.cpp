...
struct fixture {
  ...
  std::tuple<extents<>> rank_0_extents;

  std::tuple<extents<1>, extents<2>> rank_1_extents;

  std::tuple<extents<1, 1>, extents<2, 2>> rank_2_extents;

  std::tuple<extents<1>, extents<1, 1>, extents<1, 1, 1>, extents<1, 1, 1, 1>>
    scalars;

  std::tuple<extents<1, 2>,
             extents<1, 3, 1>,
             extents<1, 4, 1, 1>,
             extents<5, 1, 1, 1, 1>,
             extents<6, 1, 1, 1, 1, 1>>
  ...
  std::tuple<extents<2, 3>,
             extents<3, 2, 1>,
             extents<4, 4, 1, 1>,
             extents<6, 6, 1, 1, 1, 1>>
    matrices;

  std::tuple<extents<3, 3, 3>,
             extents<4, 4, 4, 1>,
             extents<5, 5, 5, 1, 1>,
             extents<6, 6, 6, 1, 1, 1>,
             extents<6, 6, 1, 1, 1, 6>>
...
BOOST_FIXTURE_TEST_CASE(test_static_extents_product,
                        fixture,
...
BOOST_FIXTURE_TEST_CASE(test_static_extents_access,
                        fixture,
                        *boost::unit_test::label("static_extents") *
...
BOOST_FIXTURE_TEST_CASE(test_static_extents,
                        fixture,
                        *boost::unit_test::label("static_extents") *
...
BOOST_FIXTURE_TEST_CASE(test_static_extents_valid,
                        fixture,
                        *boost::unit_test::label("static_extents") *
...
BOOST_FIXTURE_TEST_CASE(test_static_extents_comparsion_operator,
                        fixture,
                        *boost::unit_test::label("static_extents") *
                          boost::unit_test::label("comparsion_operator"))
{
...
BOOST_FIXTURE_TEST_CASE(test_static_extents_squeeze,
                        fixture,
                        *boost::unit_test::label("static_extents") *
...
BOOST_AUTO_TEST_CASE(test_static_extents_exception)
{
  ...
  BOOST_REQUIRE_THROW((void)e1.at(std::numeric_limits<size_t>::max()),
                      std::out_of_range);
}
