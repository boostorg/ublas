...
BOOST_FIXTURE_TEST_CASE(test_extents_access,
                        fixture,
                        *boost::unit_test::label("extents") *
...
BOOST_FIXTURE_TEST_CASE(test_extents_copy_ctor,
                        fixture,
                        *boost::unit_test::label("extents") *
...
BOOST_FIXTURE_TEST_CASE(test_extents_is,
                        fixture,
                        *boost::unit_test::label("extents") *
...
BOOST_FIXTURE_TEST_CASE(test_extents_squeeze,
                        fixture,
                        *boost::unit_test::label("extents") *
...
BOOST_FIXTURE_TEST_CASE(test_extents_comparison,
                        fixture,
                        *boost::unit_test::label("extents") *
...
BOOST_FIXTURE_TEST_CASE(test_extents_product,
                        fixture,
                        *boost::unit_test::label("extents") *
