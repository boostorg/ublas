...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_static_tensor_expression_retrieve_extents,
                                 value,
                                 test_types,
                                 fixture)
{
  ...
  for_each_tuple(extents, [&](auto I, auto& e1) {
    ...
    using tensor_type1 =
      ublas::static_tensor<value_type, extents_type1, layout_type>;
    ...
    for_each_tuple(extents, [&](auto J, auto& e2) {
      ...
      using tensor_type2 =
        ublas::static_tensor<value_type, extents_type2, layout_type>;
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(
  test_static_tensor_expression_all_extents_equal, value, test_types, fixture)
{
  using namespace boost::numeric;
  using value_type  = typename value::first_type;
  using layout_type = typename value::second_type;
