...
BOOST_FIXTURE_TEST_CASE(test_fixed_rank_extents_access,
                        fixture,
                        *boost::unit_test::label("basic_fixed_rank_extents") *
...
BOOST_FIXTURE_TEST_CASE(test_fixed_rank_extents_copy_ctor,
                        fixture,
                        *boost::unit_test::label("basic_fixed_rank_extents") *
...
BOOST_FIXTURE_TEST_CASE(test_fixed_rank_extents_is,
                        fixture,
                        *boost::unit_test::label("basic_fixed_rank_extents") *
...
BOOST_FIXTURE_TEST_CASE(test_fixed_rank_extents_squeeze,
                        fixture,
                        *boost::unit_test::label("basic_fixed_rank_extents") *
...
BOOST_FIXTURE_TEST_CASE(test_fixed_rank_extents_product,
                        fixture,
                        *boost::unit_test::label("basic_fixed_rank_extents") *
