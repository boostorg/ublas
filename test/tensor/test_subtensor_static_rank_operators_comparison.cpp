...
BOOST_AUTO_TEST_SUITE(test_subtensor_static_rank_comparison)
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE( test_subtensor_static_rank_comparison, value,  test_types, fixture)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE( test_subtensor_static_rank_comparison_with_tensor_expressions, value,  test_types, fixture)
{
  namespace ublas = boost::numeric::ublas;
  using value_t   = typename value::first_type;
  using layout_t  = typename value::second_type;
...
//BOOST_FIXTURE_TEST_CASE_TEMPLATE( test_subtensor_static_rank_comparison_with_scalar, value,  test_types, fixture)
//{
//  namespace ublas = boost::numeric::ublas;
//  using value_t  = typename value::first_type;
//  using layout_t = typename value::second_type;
