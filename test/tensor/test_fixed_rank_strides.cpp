...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_fixed_rank_strides_ctor, value, test_types)
{
  ...
  ub::basic_fixed_rank_strides<unsigned, 0, ub::layout::first_order> s0{
    ub::dynamic_extents<0>{}};
  BOOST_CHECK(s0.empty());
  BOOST_CHECK_EQUAL(s0.size(), 0);

  ub::basic_fixed_rank_strides<unsigned, 2, ub::layout::first_order> s1{
    ub::dynamic_extents<2>{1, 1}};
  BOOST_CHECK(!s1.empty());
  BOOST_CHECK_EQUAL(s1.size(), 2);

  ub::basic_fixed_rank_strides<unsigned, 2, ub::layout::first_order> s2{
    ub::dynamic_extents<2>{1, 2}};
  BOOST_CHECK(!s2.empty());
  BOOST_CHECK_EQUAL(s2.size(), 2);

  ub::basic_fixed_rank_strides<unsigned, 2, ub::layout::first_order> s3{
    ub::dynamic_extents<2>{2, 1}};
  BOOST_CHECK(!s3.empty());
  BOOST_CHECK_EQUAL(s3.size(), 2);

  ub::basic_fixed_rank_strides<unsigned, 2, ub::layout::first_order> s4{
    ub::dynamic_extents<2>{2, 3}};
  BOOST_CHECK(!s4.empty());
  BOOST_CHECK_EQUAL(s4.size(), 2);

  ub::basic_fixed_rank_strides<unsigned, 3, ub::layout::first_order> s5{
    ub::dynamic_extents<3>{2, 3, 1}};
  BOOST_CHECK(!s5.empty());
  BOOST_CHECK_EQUAL(s5.size(), 3);

  ub::basic_fixed_rank_strides<unsigned, 3, ub::layout::first_order> s6{
    ub::dynamic_extents<3>{1, 2, 3}};
  BOOST_CHECK(!s6.empty());
  BOOST_CHECK_EQUAL(s6.size(), 3);

  ub::basic_fixed_rank_strides<unsigned, 3, ub::layout::first_order> s7{
    ub::dynamic_extents<3>{4, 2, 3}};
...
BOOST_AUTO_TEST_CASE(test_fixed_rank_strides_ctor_access_last_order)
{
  ...
  ub::basic_fixed_rank_strides<unsigned, 2, ub::layout::last_order> s1{
    ub::dynamic_extents<2>{1, 1}};
  BOOST_REQUIRE_EQUAL(s1.size(), 2);
  BOOST_CHECK_EQUAL(s1[0], 1);
  BOOST_CHECK_EQUAL(s1[1], 1);

  ub::basic_fixed_rank_strides<unsigned, 2, ub::layout::last_order> s2{
    ub::dynamic_extents<2>{1, 2}};
  BOOST_REQUIRE_EQUAL(s2.size(), 2);
  BOOST_CHECK_EQUAL(s2[0], 1);
  BOOST_CHECK_EQUAL(s2[1], 1);

  ub::basic_fixed_rank_strides<unsigned, 2, ub::layout::last_order> s3{
    ub::dynamic_extents<2>{2, 1}};
  BOOST_REQUIRE_EQUAL(s3.size(), 2);
  BOOST_CHECK_EQUAL(s3[0], 1);
  BOOST_CHECK_EQUAL(s3[1], 1);

  ub::basic_fixed_rank_strides<unsigned, 2, ub::layout::last_order> s4{
    ub::dynamic_extents<2>{2, 3}};
  BOOST_REQUIRE_EQUAL(s4.size(), 2);
  BOOST_CHECK_EQUAL(s4[0], 3);
  BOOST_CHECK_EQUAL(s4[1], 1);

  ub::basic_fixed_rank_strides<unsigned, 3, ub::layout::last_order> s5{
    ub::dynamic_extents<3>{2, 3, 1}};
  BOOST_REQUIRE_EQUAL(s5.size(), 3);
  ...
  ub::basic_fixed_rank_strides<unsigned, 3, ub::layout::last_order> s6{
    ub::dynamic_extents<3>{1, 2, 3}};
  BOOST_REQUIRE_EQUAL(s6.size(), 3);
  ...
  ub::basic_fixed_rank_strides<unsigned, 3, ub::layout::last_order> s7{
    ub::dynamic_extents<3>{2, 1, 3}};
  BOOST_REQUIRE_EQUAL(s7.size(), 3);
  ...
  ub::basic_fixed_rank_strides<unsigned, 3, ub::layout::last_order> s8{
    ub::dynamic_extents<3>{4, 2, 3}};
  BOOST_REQUIRE_EQUAL(s8.size(), 3);
