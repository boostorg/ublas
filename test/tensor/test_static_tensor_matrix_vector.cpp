...
using test_types =
  zip<int, float>::with_t<boost::numeric::ublas::layout::first_order,
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_tensor_matrix_copy_ctor, value, test_types)
{
  ...
  ublas::static_tensor<value_type, ublas::static_extents<1, 1>, layout_type>
    a2 = matrix_type(1, 1);
  BOOST_CHECK_EQUAL(a2.size(), 1);
  BOOST_CHECK(!a2.empty());

  ublas::static_tensor<value_type, ublas::static_extents<2, 1>, layout_type>
    a3 = matrix_type(2, 1);
  BOOST_CHECK_EQUAL(a3.size(), 2);
  BOOST_CHECK(!a3.empty());

  ublas::static_tensor<value_type, ublas::static_extents<1, 2>, layout_type>
    a4 = matrix_type(1, 2);
  BOOST_CHECK_EQUAL(a4.size(), 2);
  BOOST_CHECK(!a4.empty());

  ublas::static_tensor<value_type, ublas::static_extents<2, 3>, layout_type>
    a5 = matrix_type(2, 3);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_tensor_vector_copy_ctor, value, test_types)
{
  ...
  ublas::static_tensor<value_type, ublas::static_extents<3, 1>, layout_type>
    a5 = vector_type(3);
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_matrix_copy_ctor_extents,
                                 value,
                                 test_types,
                                 fixture)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_vector_copy_ctor_extents,
                                 value,
                                 test_types,
                                 fixture)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_matrix_copy_assignment,
                                 value,
                                 test_types,
                                 fixture)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_vector_copy_assignment,
                                 value,
                                 test_types,
                                 fixture)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_matrix_move_assignment,
                                 value,
                                 test_types,
                                 fixture)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_vector_move_assignment,
                                 value,
                                 test_types,
                                 fixture)
{
  ...
  auto check = [](auto const&, auto& e) {
    ...
    if constexpr (extents_type::at(1) == 1) {
      ...
      for (auto i = 0ul; i < t.size(); ++i) { BOOST_CHECK_EQUAL(t[i], q(i)); }
    }
  };
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_matrix_expressions,
                                 value,
                                 test_types,
                                 fixture)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_vector_expressions,
                                 value,
                                 test_types,
                                 fixture)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_matrix_vector_expressions,
                                 value,
                                 test_types,
                                 fixture)
{
  ...
  auto check = [](auto const&, auto& e) {
    ...
    assert(e.size() == 2);
    auto Q = ublas::static_tensor<value_type,
                                  ublas::static_extents<extents_type::at(0), 1>,
                                  layout_type>{};
