...
struct fixture {
  ...
  std::tuple<extents_type<2>,   // 1
             extents_type<2>,   // 2
             extents_type<3>,   // 3
             extents_type<3>,   // 4
             extents_type<4>    // 5
             >
    extents = {extents_type<2>{1, 1},
               extents_type<2>{2, 3},
                                 ...
                                 fixture)
{
  ...
  for_each_tuple(extents, [](auto const&, auto& e) {
    ...
    auto t =
      ublas::fixed_rank_tensor<value_type, extents_type::_size, layout_type>{e};
                                 ...
                                 fixture)
{
  ...
  for_each_tuple(extents, [](auto const&, auto& e) {
    ...
    ublas::fixed_rank_tensor<value_type, extents_type::_size, other_layout_type>
      t           = r;
    tensor_type q = t;
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_tensor_reshape,
                                 value,
                                 test_types,
                                 fixture)
{
