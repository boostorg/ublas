...
BOOST_AUTO_TEST_SUITE ( test_shape_dynamic )


struct fixture
{
  using shape_t = boost::numeric::ublas::basic_extents<unsigned>;
                        ...
                        *boost::unit_test::label("dynamic_extents") *boost::unit_test::label("empty"))
{
    ...
    BOOST_CHECK_THROW( shape_t({1,1,0}), std::invalid_argument);
    BOOST_CHECK_THROW( shape_t({1,0})  , std::invalid_argument);
    BOOST_CHECK_THROW( shape_t({0}  )  , std::invalid_argument);
    BOOST_CHECK_THROW( shape_t({0,1})  , std::invalid_argument);
}
...
BOOST_FIXTURE_TEST_CASE(test_extents_dynamic_operator_access_write,
                        fixture,
                        *boost::unit_test::label("dynamic_extents") *boost::unit_test::label("operator_access_write"))
{
  auto n3 = shape_t{1};
  n3.at(0)=3;
