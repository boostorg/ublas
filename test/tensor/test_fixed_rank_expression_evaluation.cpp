...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(
  test_fixed_rank_tensor_expression_retrieve_extents,
  value,
  test_types,
  fixture)
{
  ...
  for_each_tuple(extents, [&](auto I, auto& e1) {
    ...
    using tensor_type1 =
      ublas::fixed_rank_tensor<value_type, extents_type1::_size, layout_type>;
    ...
    for_each_tuple(extents, [&](auto J, auto& e2) {
      ...
      using tensor_type2 =
        ublas::fixed_rank_tensor<value_type, extents_type2::_size, layout_type>;
      ...
      // uexpr2 = 2+t2
      auto uexpr1 =
        ublas::detail::make_unary_tensor_expression<tensor_type1>(t1, uplus1);
      auto uexpr2 =
        ublas::detail::make_unary_tensor_expression<tensor_type2>(t2, uplus2);
      ...
      if constexpr (extents_type1::_size == extents_type2::_size) {
        ...
        auto bexpr_uexpr =
          ublas::detail::make_binary_tensor_expression<tensor_type1>(
            uexpr1, uexpr2, bplus);
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(
  test_fixed_rank_tensor_expression_all_extents_equal,
  value,
  test_types,
  fixture)
{
